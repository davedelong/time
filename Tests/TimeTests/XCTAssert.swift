...
@discardableResult
func XCTAssertEqualWithAccuracyWorkaround<FP: BinaryFloatingPoint>(_ value1: FP, _ value2: FP, accuracy: FP, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEEra>(_ time: Fixed<U>, era: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEYear>(_ time: Fixed<U>, era: Int, year: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEMonth>(_ time: Fixed<U>, era: Int, year: Int, month: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEDay>(_ time: Fixed<U>, era: Int, year: Int, month: Int, day: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEHour>(_ time: Fixed<U>, era: Int, year: Int, month: Int, day: Int, hour: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOEMinute>(_ time: Fixed<U>, era: Int, year: Int, month: Int, day: Int, hour: Int, minute: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOESecond>(_ time: Fixed<U>, era: Int, year: Int, month: Int, day: Int, hour: Int, minute: Int, second: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
...
@discardableResult
func XCTAssertTime<U: StandardUnit & LTOENanosecond>(_ time: Fixed<U>, era: Int, year: Int, month: Int, day: Int, hour: Int, minute: Int, second: Int, nanosecond: Int, file: StaticString = #filePath, line: UInt = #line) -> Bool {
