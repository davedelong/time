...
class LinuxIssues: XCTestCase {
    ...
    func testFormatting() throws {
        ...
        let allFormats: Array<(Format, String, String, StaticString, UInt)> = [
            ...
            (Template<TimeZone>.shortLocalizedGMT,                                              "GMT+0",                "GMT+0",                #filePath,  #line),
            (Template<TimeZone>.longLocalizedGMT,                                               "GMT+00:00",            "GMT+00:00",            #filePath,  #line),
            ...
            (Template<TimeZone>.exemplarCity,                                                   "Unknown Location",     "Unknown Location",     #filePath,  #line),
            (Template<TimeZone>.genericLocation,                                                "GMT+00:00",            "GMT+00:00",            #filePath,  #line),
